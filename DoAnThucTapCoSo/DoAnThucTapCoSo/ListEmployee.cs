...
namespace DoAnThucTapCoSo
{
    public class ListEmployee
    {
        ...
        public void Display()
        {
            ...
            {
                Console.WriteLine(employee.Data.Name + "\t\t" + employee.Data.BirthDay + "\t\t" + employee.Data.Position + "\t\t" + employee.Data.CoefficienceSalary + "\n");
            }
        }
        ...
        public void DisplayConsole()
        {
            for (Node<Employee> employee = FirstEmployee; employee != null; employee = employee.Next)
            {
                if (employee.Data.Name.Length < 17)
                    Console.WriteLine(employee.Data.Name + "\t\t\t" + employee.Data.BirthDay + "\t\t" + employee.Data.Position + "\t\t" + employee.Data.CoefficienceSalary + "\n");
                else
                {
        ...
        public bool Contains(Node<Employee> employee)
        {
            for (Node<Employee> emp = FirstEmployee; emp != null; emp = emp.Next)
            {
                if (emp.Data.Name == employee.Data.Name && emp.Data.Position == employee.Data.Position && emp.Data.BirthDay == employee.Data.BirthDay && emp.Data.CoefficienceSalary == employee.Data.CoefficienceSalary)
                    return true;
            }
            return false;
        }
        ...
        public Node<Employee> SearchFirst(string keyword)
        {
            int count = -1;
            ...
            {
                count++;
                if (StringProcessing.ConvertToUnSign(employee.Data.Name.ToLower()).Contains(unsignKeyword) || StringProcessing.ConvertToUnSign(employee.Data.Position.ToLower()).Contains(unsignKeyword) || employee.Data.BirthDay.ToString().Contains(unsignKeyword) || employee.Data.CoefficienceSalary.ToString().Contains(unsignKeyword))
                {
                    employee.OrderNumber = count;
                    return employee;
                }
        ...
        public ListEmployee SearchMultiple(string keyword)
        {
